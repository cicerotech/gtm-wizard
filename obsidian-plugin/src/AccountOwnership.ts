...
/**
 * Static CS account fallback data (from Salesforce: CS Staffing + Existing Customers)
 * Used when server is unavailable (Render cold start, Salesforce not ready).
 * 100 accounts: Late-stage pipeline (CS Staffing flagged) + Existing customers (MSA/Pilot)
 * Source: /api/bl-accounts/nikhita.godiwala@eudia.com (live server, Feb 2026)
 */
export const CS_STATIC_ACCOUNTS: OwnedAccount[] = [
  { id: 'cs-static-accenture', name: 'Accenture', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-aes', name: 'AES', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-airbnb', name: 'Airbnb', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-airship', name: 'Airship Group Inc', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-amazon', name: 'Amazon', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-anthropic', name: 'Anthropic', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-appliedai', name: 'AppliedAI', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-arabic-cs', name: 'Arabic Computer Systems', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Alex Fox' },
  { id: 'cs-static-aramark', name: 'Aramark Ireland', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-army-corps', name: 'Army Corps of Engineers', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mike Masiello' },
  { id: 'cs-static-aryza', name: 'Aryza', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-asana', name: 'Asana', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-aviva', name: 'Aviva Insurance', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-boi', name: 'Bank of Ireland', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Tom Clancy' },
  { id: 'cs-static-bayer', name: 'Bayer', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-best-buy', name: 'Best Buy', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-bny-mellon', name: 'BNY Mellon', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-cargill', name: 'Cargill', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-chevron', name: 'Chevron', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-chs', name: 'CHS', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-coherent', name: 'Coherent', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-coillte', name: 'Coillte', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-coimisiun', name: 'Coimisiun na Mean', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-coleman', name: 'Coleman Legal', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Keigan Pesenti' },
  { id: 'cs-static-commscope', name: 'CommScope Technologies', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-consensys', name: 'Consensys', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-corebridge', name: 'Corebridge Financial', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-cox', name: 'Cox Media Group', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Justin Hills' },
  { id: 'cs-static-creed', name: 'Creed McStay', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Keigan Pesenti' },
  { id: 'cs-static-datalex', name: 'Datalex', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-davy', name: 'Davy', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-delinea', name: 'Delinea', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Justin Hills' },
  { id: 'cs-static-dept-children', name: 'Department of Children, Disability and Equality', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Alex Fox' },
  { id: 'cs-static-dept-climate', name: 'Department of Climate, Energy and the Environment', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Alex Fox' },
  { id: 'cs-static-dhl', name: 'DHL', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-dolby', name: 'Dolby', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-dropbox', name: 'Dropbox', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-duracell', name: 'Duracell', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Justin Hills' },
  { id: 'cs-static-ecms', name: 'ECMS', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-ecolab', name: 'Ecolab', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-esb', name: 'Electricity Supply Board', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Tom Clancy' },
  { id: 'cs-static-esb-ni', name: 'ESB NI/Electric Ireland', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Alex Fox' },
  { id: 'cs-static-etsy', name: 'Etsy', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-fox', name: 'Fox', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-fresh-del-monte', name: 'Fresh Del Monte', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-ge-vernova', name: 'GE Vernova', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Ananth Cherukupally' },
  { id: 'cs-static-gilead', name: 'Gilead Sciences', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-glanbia', name: 'Glanbia', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Tom Clancy' },
  { id: 'cs-static-goodbody', name: 'Goodbody Stockbrokers', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-graybar', name: 'Graybar Electric', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-hayes', name: 'Hayes Solicitors LLP', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Keigan Pesenti' },
  { id: 'cs-static-home-depot', name: 'Home Depot', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mitch Loquaci' },
  { id: 'cs-static-indeed', name: 'Indeed', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-intuit', name: 'Intuit', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-iqvia', name: 'IQVIA', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Sean Boyd' },
  { id: 'cs-static-kellanova', name: 'Kellanova', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-keurig', name: 'Keurig Dr Pepper', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-kingspan', name: 'Kingspan', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-mediolanum', name: 'Mediolanum', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-medtronic', name: 'Medtronic', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-meta', name: 'Meta', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-national-grid', name: 'National Grid', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-nato', name: 'NATO', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mike Masiello' },
  { id: 'cs-static-northern-trust', name: 'Northern Trust Management Services', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-novelis', name: 'Novelis', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mitch Loquaci' },
  { id: 'cs-static-ntma', name: 'NTMA', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Emer Flynn' },
  { id: 'cs-static-openai', name: 'OpenAi', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-orsted', name: 'Orsted', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-peregrine', name: 'Peregrine Hospitality', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Ananth Cherukupally' },
  { id: 'cs-static-perrigo', name: 'Perrigo Pharma', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-petsmart', name: 'Petsmart', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-plusgrade', name: 'Plusgrade', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-pure-storage', name: 'Pure Storage', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Ananth Cherukupally' },
  { id: 'cs-static-re-turn', name: 'Re-Turn', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-salesforce', name: 'Salesforce', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-sequoia', name: 'Sequoia Climate Fund', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-servicenow', name: 'ServiceNow', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-sisk', name: 'Sisk Group', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Alex Fox' },
  { id: 'cs-static-southwest', name: 'Southwest Airlines', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-spark', name: 'Spark Brighter Thinking', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Ananth Cherukupally' },
  { id: 'cs-static-stripe', name: 'Stripe', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nicola Fratini' },
  { id: 'cs-static-tailored-brands', name: 'Tailored Brands', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-taoglas', name: 'Taoglas Limited', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-te-connectivity', name: 'TE Connectivity', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-teamwork', name: 'Teamwork.com', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-weir-group', name: 'The Weir Group PLC', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-wonderful', name: 'The Wonderful Company', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
  { id: 'cs-static-tiktok', name: 'TikTok', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-tinder', name: 'Tinder LLC', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-toshiba', name: 'Toshiba US', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-usaf', name: 'U.S. Air Force', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mike Masiello' },
  { id: 'cs-static-udemy', name: 'Udemy', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Nathan Shine' },
  { id: 'cs-static-uisce', name: 'Uisce Eireann (Irish Water)', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Tom Clancy' },
  { id: 'cs-static-vista', name: 'Vista Equity Partners', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Ananth Cherukupally' },
  { id: 'cs-static-vulcan', name: 'Vulcan Special Ops', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Mike Masiello' },
  { id: 'cs-static-ww-grainger', name: 'W.W. Grainger', type: 'New', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-wealth-partners', name: 'Wealth Partners Capital Group', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Asad Hussain' },
  { id: 'cs-static-wellspring', name: 'Wellspring Philanthropic Fund', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Conor Molloy' },
  { id: 'cs-static-western-digital', name: 'Western Digital', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Olivia Jung' },
  { id: 'cs-static-world-wide-tech', name: 'World Wide Technology', type: 'Existing', isOwned: false, hadOpportunity: true, website: null, industry: null, csmName: null, ownerName: 'Julie Stefanich' },
];
