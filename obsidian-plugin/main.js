...
`,r=`${e}/_Account Info.md`;await this.app.vault.create(r,i)}async createFullAccountSubnotes(e,t,n){let a=[{name:"Note 1.md",content:`---
account: "${t.name}"
account_id: "${t.id}"
type: meeting_note
sync_to_salesforce: false
