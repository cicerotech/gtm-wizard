...
- Action items have clear owners`}function We(O,a){let e="";return a?.account&&(e=`
ACCOUNT CONTEXT:
...
`}function Ie(O,a){let e="";return a?.account&&(e=`
ACCOUNT CONTEXT:
- Account: ${a.account.name}
${a.account.owner?`- Owner: ${a.account.owner}`:""}
...
`}function Te(O,a){let e="";return a?.account&&(e=`
ACCOUNT CONTEXT:
- Account: ${a.account.name}
${a.account.owner?`- Owner: ${a.account.owner}`:""}
...
`;if(b.length>0){f+=`| Account | Type | Owner | Folder |
|---------|------|-------|--------|
`;for(let h of b){let S=h.name.replace(/[<>:"/\\|?*]/g,"_").trim();f+=`| ${h.name} | ${h.type||""} | ${h.ownerName||""} | [[Accounts/${S}/Contacts\\|View]] |
