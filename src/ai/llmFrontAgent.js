  ...
  constructor() {
    ...
    this.availableFunctions = {
      ...
      'account_reassign': {
        ...
        examples: ['reassign Dolby to Julie', 'transfer Ecolab to Nathan'],
  ...
  generateClarification(understanding) {
    ...
    if (understanding.function === 'account_reassign') {
      ...
      if (!understanding.params.newOwner) {
        return `Got it - reassigning ${understanding.params.companyName}. Who should I assign it to? (Julie Stefanich, Nathan Agarwal, Justin Hills, etc.)`;
      }
    }
