  ...
  buildIntentDefinitions() {
    return {
      ...
      pipeline_by_owner: {
        ...
        examples: ['julie\'s deals', 'show me himanshu pipeline', 'what does justin have', 'asad\'s opportunities'],
        entities: ['owners']
      },
      late_stage_pipeline: {
      ...
      owner_accounts_list: {
        ...
        examples: ['julie\'s accounts', 'what accounts does himanshu own', 'show me justin\'s accounts'],
        entities: ['ownerName']
      },
