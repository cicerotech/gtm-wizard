...
class IntentClassifier {
  ...
  initialize() {
    ...
    this.trainingData = [
      ...
      { query: "what opps does Dolby have", intent: "account_opportunities" },
      ...
      { query: "target close date for Ecolab", intent: "loi_date" },
      { query: "expected sign date", intent: "loi_date" },
      { query: "last meeting with intel", intent: "last_meeting" },
      { query: "when did we meet Pure Storage", intent: "last_meeting" },
      { query: "recent call with", intent: "last_meeting" },
      { query: "legal contacts at Bayer", intent: "contacts" },
      ...
      { query: "create opportunity for Asana", intent: "create_opportunity" },
