...
<div class="tips-grid">
<div class="tip"><b>Use first names</b> for BLs: Julie, Mitchell, Asad</div>
...
<div class="card" data-k="accounts owner julie mitchell steven asad portfolio"><div class="card-title">Accounts by Owner</div><div class="card-desc">All accounts owned by someone</div><div class="examples"><div class="example"><code class="code">what accounts does Julie own</code><button class="copy">copy</button></div><div class="example"><code class="code">Mitchell's accounts</code><button class="copy">copy</button></div></div></div>
...
<div class="card" data-k="owner pipeline deals julie mitchell steven"><div class="card-title">Someone's Pipeline</div><div class="card-desc">Specific person's deals</div><div class="examples"><div class="example"><code class="code">Mitchell's deals</code><button class="copy">copy</button></div><div class="example"><code class="code">Julie's pipeline</code><button class="copy">copy</button></div></div></div>
...
<div class="cards">
<div class="card" data-k="reassign account assign transfer owner single"><div class="card-title">Reassign Account</div><div class="card-desc">Change account ownership (US: Asad, Mitchell, Julie, Olivia, Ananth, Justin | EU: Greg, Nathan, Tom, Conor, Alex, Nicola, Emer)</div><div class="examples"><div class="example"><code class="code">reassign Dolby to Asad</code><button class="copy">copy</button></div><div class="example"><code class="code">assign Ecolab to Mitchell</code><button class="copy">copy</button></div><div class="example"><code class="code">assign Fresh Del Monte to Nathan</code><button class="copy">copy</button></div></div></div>
