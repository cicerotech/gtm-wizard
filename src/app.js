...
<div class="card" data-k="contracts active list show"><div class="card-title">Contracts</div><div class="card-desc">Contract records</div><div class="examples"><div class="example"><code class="code">show contracts</code><button class="copy">copy</button></div><div class="example"><code class="code">contracts for Cargill</code><button class="copy">copy</button></div></div></div>
</div>
</section>
...
<div class="cards">
<div class="card" data-k="reassign account assign transfer owner single"><div class="card-title">Reassign Account</div><div class="card-desc">Change account ownership (US: Asad, Himanshu, Julie, Olivia, Ananth, Justin | EU: Greg, Nathan, Tom, Conor, Alex, Nicola, Emer)</div><div class="examples"><div class="example"><code class="code">reassign Boeing to Asad</code><button class="copy">copy</button></div><div class="example"><code class="code">assign Intel to Himanshu</code><button class="copy">copy</button></div><div class="example"><code class="code">assign Nestlé to Nathan</code><button class="copy">copy</button></div></div></div>
<div class="card" data-k="batch reassign multiple accounts bulk"><div class="card-title">Batch Reassign</div><div class="card-desc">Reassign multiple accounts at once</div><div class="examples"><div class="example"><code class="code">batch reassign: Boeing, Intel, Microsoft to Julie</code><button class="copy">copy</button></div><div class="example"><code class="code">reassign Siemens, BMW to Greg</code><button class="copy">copy</button></div></div></div>
